    ...
    <div>
      <div className="flex flex-col space-y-4 items-center justify-center bg-green-200 text-[#0F092D] w-full min-h-screen">
        ...
        <div className="flex flex-col space-y-4 items-center justify-center w-96">
          <button className='w-full py-2 bg-[#28FF64] text-[#0F092D] font-semibold text-lg rounded-lg shadow-lg shadow-green-400/30 hover:shadow-green-400/50' onClick={() => login()}>Sign Up</button>
          <Link to='/login' className="text-sm font-medium text-center text-[#0F092D] hover:text-[#28FF64]">Already have an account! Login here</Link>  
        </div>
      </div>
    </div>
  )
